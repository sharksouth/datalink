; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30141.0 
	...
	TITLE	c:\users\sharksouth\onedrive\学习资料\计算机网络\课程实验\lab1-2022(win+linux)\lab1-windows-vs2019\win32-release\protocol.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0M@GDNJPMDL@Apr?517?52022@		; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0M@GDNJPMDL@Apr?517?52022@
CONST	SEGMENT
??_C@_0M@GDNJPMDL@Apr?517?52022@ DB 'Apr 17 2022', 00H	; `string'
CONST	ENDS
...
; File C:\Users\sharksouth\OneDrive\学习资料\计算机网络\课程实验\Lab1-2022(Win+Linux)\Lab1-Windows-VS2019\protocol.c
;	COMDAT _put_packet
_TEXT	SEGMENT
...
; 243  : 	lprintf("Protocol.lib, version %s, jiangyanjun0718@bupt.edu.cn\n", VERSION, __DATE__);
	...
	push	OFFSET ??_C@_0M@GDNJPMDL@Apr?517?52022@
